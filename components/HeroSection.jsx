          ...
          <div className="flex flex-col justify-center items-center lg:flex-row-reverse lg:justify-start lg:ml-16 ">
            <div className="basis-1/2 ">
              <div className="flex justify-between md:justify-evenly items-center p-5 mx-5 pt-20 ">
                <div
                  data-aos="fade-right"
                  className="flex flex-col justify-center items-center lg:mt-[-25px]"
                >
                  <img
                ...
                <div
                  data-aos="fade-down"
                  className="flex flex-col justify-center items-center lg:mt-[-35px]"
                >
                  <img
                    className="w-16 "
                ...
                <div
                  data-aos="fade-left"
                  className="flex flex-col justify-center items-center lg:mt-[-50px]"
                >
                  <img
                    className="w-16 lg:w-20"
              ...
              <h1
                ...
                data-aos="fade-up"
                className="text-center text-5xl lg:text-6xl leading-[50px] lg:leading-[70px] font-medium md:p-10 text-[#042879] "
              >
              ...
              <h1
                ...
                data-aos="fade-up"
                className="text-center text-3xl text-[#042879]"
              >
              ...
              <button
                ...
                className="flex mx-auto cursor-pointer text-white bg-[#fd7510] border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg my-5 mt-10"
              >
                Contact Us
              </button>
